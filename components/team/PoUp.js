                  ...
                  <div className="slider-for">
                    <div>
                      <div className="slide-box">
                        {' '}
                        <img
                          src="/assets/media/team/product1.jpg"
                          alt=""
                        />{' '}
                      </div>
                    </div>
              ...
              <div className="product-detail-box">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    ...
                    <p className="brief">
                      ...
                      Aliquam tristique purus vitae venenatis ultrices.
                      Suspendisse tristique tortor ante,{' '}
                    </p>
                  </div>
                </div>
                ...
                <div className="row cart-row">
                  <div className="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <a href="#!" className="btn btn-primary">
                      <i className="fa fa-heart-o" aria-hidden="true"></i> Add
                      To wishlist{' '}
                    </a>{' '}
                  </div>
                </div>
