...
<div className="prfoile_tab_data white_bg">
  ...
  <div className="tab hide" id="store">
    <div class="products">
      <ul>
        <li>
          <div class="pro_img"> <a href="#prod1" className="quickpoup"><img src="/assets/media/team/tshirt1.jpg" alt="" /></a> <span class="size_option">36d 12h 13m 18s</span> </div>
          <div class="pro_bottom">
            <div class="name_dots">
              <h4>ALCHEMISTS MEN-SHIRT</h4>
              <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
            <div class="stars"> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a>
        ...
        <li>
          <div class="pro_img"> <img src="/assets/media/team/tshirt2.jpg" alt="" /> <span class="size_option">36d 12h 13m 18s</span> </div>
          <div class="pro_bottom">
            <div class="name_dots">
              <h4>ALCHEMISTS MEN-SHIRT</h4>
              <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
        ...
        <li>
          <div class="pro_img"> <img src="/assets/media/team/tshirt1.jpg" alt="" /> <span class="size_option">36d 12h 13m 18s</span></div>
          <div class="pro_bottom">
            <div class="name_dots">
              <h4>ALCHEMISTS MEN-SHIRT</h4>
              <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
        ...
        <li>
          <div class="pro_img"> <img src="/assets/media/team/cup.jpg" alt="" /> <span class="size_option">36d 12h 13m 18s</span></div>
          <div class="pro_bottom">
            <div class="name_dots">
              <h4>ALCHEMISTS MEN-SHIRT</h4>
              <a href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
