      ...
      <table className="table">
        <thead>
          <tr>
            ...
            <th scope="col">Pentakills</th>
            <th scope="col">KDR.R</th>
            <th scope="col">DMG%</th>
            <th scope="col">Dpm</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span className="dp"><img src="/assets/media/user.jpg" alt="" /></span> <span className="dp_name">Rangnrk<b>offensive</b></span></td>
            <td>18</td>
            <td>9</td>
            <td>34</td>
            <td>2</td>
