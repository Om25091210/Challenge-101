...
return(
  ...
  <div className="products">
        <ul>
          ...
          <li>
            <div className="pro_img">  <a href="#"><img src="/assets/media/team/tshirt2.jpg" alt="" /> </a><span className="size_option">36d 12h 13m 18s</span> </div>
            <div className="pro_bottom">
              <div className="name_dots">
                <h4>ALCHEMISTS MEN-SHIRT</h4>
                <a href="#"><i className="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
          ...
          <li>
            <div className="pro_img">  <a href="#"><img src="/assets/media/team/tshirt1.jpg" alt="" /> </a> <span className="size_option">36d 12h 13m 18s</span></div>
            <div className="pro_bottom">
              <div className="name_dots">
                <h4>ALCHEMISTS MEN-SHIRT</h4>
                <a href="#"><i className="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
          ...
          <li>
            <div className="pro_img">  <a href="#"><img src="/assets/media/team/cup.jpg" alt="" /> </a> <span className="size_option">36d 12h 13m 18s</span></div>
            <div className="pro_bottom">
              <div className="name_dots">
                <h4>ALCHEMISTS MEN-SHIRT</h4>
                <a href="#"><i className="fa fa-ellipsis-h" aria-hidden="true"></i></a> </div>
