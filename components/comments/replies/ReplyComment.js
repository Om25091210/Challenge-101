...
const Reply_Comment = ({postId, commentId}) => {
    ...
    return (
        <>
           <div className="reply_comment"> <button onClick={() => setReplyModal(true)}>Reply</button></div>

            {replyModal && (
                <form onSubmit={(e) => e.preventDefault()}>
                    <textarea placeholder="Add a reply" name="text" value={reply} onChange={onChange}></textarea>
