                ...
                <div className="reply_list">
                    {replies.map((reply) => (
                        <article key={reply._id}>
                            ...
                            <a href="#"><span className="avtar"><img src="" /></span></a>  
                            <div className="comments_data">
                               <div className="member_profile"> 
                               <a href="#"><h3>Name</h3> <span className="pos">Head of Department</span></a>
                               </div>
                                <p>{reply.text}-{reply.user}</p>
                            </div>
                            </div>
                          <div className="social_bar d-flex"> 
                            
                            <LikeReply postId={postId} commentId={commentId} replyId={reply} />
