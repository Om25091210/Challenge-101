...
<div className="left_side">
  <nav>
    <ul>
      <li><a href="/dashboard" className="active"><span className="iconbg"><i className="fa fa-home" aria-hidden="true"></i></span> <span className="title">HOME</span></a> </li>
      <li><a href="/ranking" className=""><span className="iconbg"><i className="fa fa-trophy" aria-hidden="true"></i></span> <span className="title">RANKING</span></a> </li>
